...
export const metadata: Metadata = { title: "Le week-end en chiffres", description: "Le week-end d'athlétisme en chiffres : podiums, records et meilleures performances publiées par la fédération.", alternates: { canonical: "/week-end" } };
