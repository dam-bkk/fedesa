<section  id="partenaires" style={{"paddingTop":"0"}}>
  <div  className="wrap">
    <div  className="sec-head" style={{"marginBottom":"6px"}}>
      <div><div  className="eyebrow">Ils courent avec nous</div><h2  style={{"marginTop":"14px"}}>Partenaires</h2></div>
      <a  href="#" className="sec-link">Devenir partenaire</a>
    </div>
    <div  className="ptier"><div  className="plab">Institutions</div>
      <div  className="prow">
        <div  className="plogo real"><img  className="plogo-img" src="img/logos/wa.svg" alt="World Athletics" style={{"maxHeight":"22px"}} /></div>
    ...
    <div  className="ptier"><div  className="plab">Sponsors officiels</div>
      <div  className="prow">
        ...
        <div  className="plogo"><span  className="pmark"><svg  viewBox="0 0 32 32" width="26" height="26" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" aria-hidden="true"><path  d="M16 28V14" /><path  d="M7 12c2-4 5-5 9-5s7 1 9 5c-3 2-6 2-9 2s-6 0-9-2z" /><path  d="M12 14l-3-3M20 14l3-3" /></svg></span><span  className="pname">Baobab Sport</span></div>
        <div  className="plogo"><span  className="pmark"><svg  viewBox="0 0 32 32" width="26" height="26" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" aria-hidden="true"><path  d="M16 4c5 7 8 10 8 14a8 8 0 0 1-16 0c0-4 3-7 8-14z" /></svg></span><span  className="pname">Kirène</span></div>
      </div></div>
  </div>
</section>
